...
export default function Sidebar({ orgId = null, orgName = null, myRole = null }) {
  ...
  // Mobile drawer: remember the path it was opened on so it auto-closes on navigation
  ...
  return (
    <>
      {/* Mobile Top Bar */}
      <div className="lg:hidden sticky top-0 z-30 h-14 flex items-center justify-between gap-3 border-b border-slate-200/80 bg-white/90 backdrop-blur-md px-4">
        ...
        <button
          ...
          aria-expanded={open}
          className="p-2 -mr-2 rounded-lg text-slate-600 hover:bg-slate-100 hover:text-slate-900 transition"
        >
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 shrink-0 border-r border-slate-200/80 bg-white flex flex-col justify-between h-dvh overflow-y-auto select-none transition-transform duration-200 lg:sticky lg:top-0 lg:z-20 lg:h-screen lg:translate-x-0 ${
        ...
        <div>
          <div className="h-16 flex items-center px-6 border-b border-slate-100 gap-3">
            ...
            <button
              ...
              className="lg:hidden ml-auto p-1.5 -mr-2 rounded-lg text-slate-400 hover:bg-slate-100 hover:text-slate-700 transition"
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
